...
public class UploadUI {
	...
	private void basic(HorizontalLayout layout) {
		...
		imageFrame.setWidth(100.0f, Unit.PIXELS);
	...
	public String viewImage(byte[] myimage, String name) {
		String basepath = VaadinService.getCurrent().getBaseDirectory().getAbsolutePath() + "/VAADIN/themes/crystal-mm/img/"
				+ name + ".png";
